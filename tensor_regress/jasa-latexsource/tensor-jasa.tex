...
%\end{align}
%where the entries of $\tY$ are independent random variables conditional on $\tX$, and $\tB\in\mathbb{R}^{p_1\times \cdots\times p_K}$ is the low-rank coefficient tensor of interest. 
