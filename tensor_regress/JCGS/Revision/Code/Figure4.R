...
# load pre-saved data
load("presaved/Figure4_mode.RData")
...
# load pre-saved data
load("presaved/Figure4_sample.RData")
  ...
  for (r in 1:2) { # rank
    ...
    for (i in 1:3) { # # of informative modes
      ...
      for (n in 1:dup) {
        ...
        } else if (i == 2) { # two mode covariate
        ...
        mreg_res <- search_GLM(as.tensor(data$tsr[[n]]), data$X_covar3, data$U, rank_range, sparsity_range, dist = "normal")
...
write.mat(sample_list, "Figure4_mode_data.mat")

# read output from Figure4.m
supcp_result <- read.mat("mat_output/Figure4_mode.mat")
...
save(final_mode, final_sd_mode, final_mode_cor, final_sd_mode_cor, file = "presaved/Figure4_mode.RData")
...
# save data in .mat file
sample_list <- list(tsr = tsr_list_s, y = x_list_s, x_true = u_list_s, para = para_list_s)
write.mat(sample_list, "Figure4_sample_data.mat")

# read output from Figure4.m
supcp_result <- read.mat("mat_output/Figure4_sample.mat")
...
save(final_sample, final_sd_sample, final_sample_cor, final_sd_sample_cor, file = "presaved/Figure4_sample.RData")
