#### merge the output file in form paste0("s_",s,"_r_",r,"_i_",i,"_n_",n,"_fig5_mode.RData") 
...
for (s in 1:2) {
    for (r in 1:2) {
        for (i in 1:3){
            ...
            for (n in 1:dup){
                file = paste0("home/jhu267/jcgs-code/Figure5/mode_output_v1/","s_",s,"_r_",r,"_i_",i,"_n_",n,"_fig5_mode.RData")
                load(file)
            ...
            final_mode[s,r,i,1:4] = apply(err_table, 2, mean)
            final_sd_mode[s,r,i,1:4] = apply(err_table, 2, sd)

            final_mode_cor[s,r,i,1:4] = apply(cor_table, 2, mean)
            final_sd_mode_cor[s,r,i,1:4] = apply(cor_table, 2, sd)
        }
    }
}

save(final_mode, final_sd_mode, final_mode_cor, final_sd_mode_cor, file = "mode_fig5_v1.RData")


####### merge .mat file in form into one big file paste0("s_",s,"_r_",r,"_i_",i,"_n_",n,"_fig5_mode.mat")
...
for (s in 1:2) {
    ...
    for (r in 1:r) {
        ...
        for (i in 1:3) {
           ...
           for (n in 1:dup) {
              file = paste0("home/jhu267/jcgs-code/Figure5/mode_output_v1/","s_",s,"_r_",r,"_i_",i,"_n_",n,"_fig5_mode.mat")
...
write.mat(sample_list,"mode_fig5_v1.mat")
