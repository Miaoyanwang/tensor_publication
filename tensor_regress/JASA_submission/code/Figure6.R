### Code for Figure 6. HCP data analysis
...
## the following line takes quite a while to finish. We do not sugget to run on personal laptop. We implement it in the server.
...
### the matrix for plotting brain connectivity is saved in presaved/data_for_Figure6
