## Code for Supplementary Figure2. Comparison of mean sqaured prediction error between our method and the other three previous methods
...
pdf("SFigure2.pdf",width=21,height=3)
s=r=1;
...
save(final,finalsd,file="SFigure2.RData")
